...
function createTimerWindow() {
    ...
    let ButtonAnalyseVideo = createButton({label: "ANALYSE"}, () => {
		analyseVideo();
	});
	...
	timerWindow.append(timerHeader, ButtonMarkIn, ButtonMarkOut, ButtonAnalyseVideo, frameBck, frameFwd, timeResultWrapper);

	assignAll([ButtonMarkIn.style, ButtonMarkOut.style, ButtonAnalyseVideo.style, frameFwd.style, frameBck.style], {
		top: "-37px",
		transition: "top 0.2s",
		margin: "4px 0 0 4px"
	});
